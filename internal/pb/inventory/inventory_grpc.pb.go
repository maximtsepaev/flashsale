...
const (
	...
	InventoryService_ReserveProduct_FullMethodName = "/InventoryService/ReserveProduct"
)
...
func (c *inventoryServiceClient) ReserveProduct(ctx context.Context, in *ReserveRequest, opts ...grpc.CallOption) (*ReserveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedInventoryServiceServer) ReserveProduct(context.Context, *ReserveRequest) (*ReserveResponse, error) {
...
func _InventoryService_ReserveProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).ReserveProduct(ctx, req.(*ReserveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
